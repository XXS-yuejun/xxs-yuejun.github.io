...
(function(w) {
    ...
    function initSetting() {
        ...
        if (cookie('Score')) {
            document.getElementById('Score').value = cookie('Score');
            _gameScoreNum = parseInt(cookie('Score'));
            gameRestart();
        }
    }
    ...
    w.save_cookie = function() {
        const settings = ['username', 'message', 'keyboard', 'title', 'Score'];
